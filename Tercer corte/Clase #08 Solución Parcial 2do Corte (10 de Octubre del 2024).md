...
$$\left( 1.53·10^{-7}A0 - 0.88B0 \right) + \left(6.25*10^{-7}A0 + 1.53*10^{-7}A1 + 2.75B0 - 0.88B1 \right)z + \left(1.61·10^{−7}A0 + 6.25·10^{−7}A1 + 1.53·10^{−7}A2 - 2.87B0 + 2.75B1 - 0.88B2 \right)z^2 + \left(1.61·10^{−7}A1 + 2.75B2 - 2.87B1 + 6.25·10^{−7}A2 + B0)z^3 + \left(1.61·10^{−7}A2 + B1 - 2.87B2)z^4 + B2z^5$$
