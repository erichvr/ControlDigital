...
$$\left( 1.53·10^{-7}A0 - \frac{22}{25}B0 \right) + \left(6.25*10^{-7}A0 + 1.53*10^{-7}A1 + \frac{11}{4}B0 - \frac{22}{25}B1 \right)z + \left( 1.61*10^{-7}A0 + 6.25*10^{-7}A1 + 1.53*10^{-7}A2 - 2.87B0 + \frac{11}{4}B1 - \frac{22}{25}B2 \right)z^2 + \left( \frac{6082408029936103A1}{37778931862957161709568} + \frac{11B2}{4} - \frac{287B1}{100} + \frac{5902958103587057}{9444732965739290427392}A2 + B0 \right)z^3 + \left( \frac{6082408029936103}{37778931862957161709568}A2 + B1 - \frac{287}{100}B2 \right)z^4 + B2z^5 $$

((1.61*10^{-7}A0 + 6.25*10^{-7}A1 + 1.53*10^{-7}A2 - 2.87B0 + (11)/4B1 - (22)/25B2)z^2 + ((6082408029936103*A1)/37778931862957161709568 + (11*B2)/4 - (287*B1)/100 + (5902958103587057*A2)/9444732965739290427392 + B0)z^3 + ((6082408029936103*A2)/37778931862957161709568 + B1 - (287*B2)/100)z^4 + (B2)z^5
